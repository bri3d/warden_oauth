...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-05-25}
  s.description = %q{ 
      warden_oauth2 will help you create oauth authentication strategies using the oauth
  ...
  s.files = [
    ".document",
     ...
     "spec/spec.opts",
     "spec/spec_helper.rb",
     "spec/warden_oauth2/config_extension_spec.rb",
     "spec/warden_oauth2/strategy_spec.rb",
